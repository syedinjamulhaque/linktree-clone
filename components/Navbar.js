...
const Navbar = () => {
  return (
    <header className="absolute inset-x-0 top-0 z-50 px-3 pt-3 sm:px-5 sm:pt-5">
      <nav className="mx-auto flex w-full max-w-7xl items-center justify-between rounded-full bg-white px-4 py-3 shadow-sm sm:px-5 lg:px-7">
